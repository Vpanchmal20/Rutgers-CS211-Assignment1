...
formats = {'first':'file', 'second':'file', 'third':'file', 'fourth':'file', 'fifth':'file', 'sixth':'line', 'seventh':'line', 'eighth':'file', 'ninth':'file', 'tenth':'file'}# if a program has single liner input and output, we put all test cases in single file. Otherwise, we have a file for test and associated file with results
weight = {'first':1.25, 'second':0.625, 'third':1.25, 'fourth':1.0, 'fifth':1.0, 'sixth':1.25, 'seventh':0.25, 'eighth':1.5, 'ninth':2.5}
